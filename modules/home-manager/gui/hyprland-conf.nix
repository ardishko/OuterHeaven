  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      windowrulev2 = [
        ...
        "workspacesilent 4,class:^(libreoffice*)"
        "workspacesilent 5,initialTitle:^(nvim)"
        "workspacesilent 6,class:^(krita)"
        "workspacesilent 6,class:^(.gimp-2.10-wrapped_)"
        "workspacesilent 7,class:^(evince)"
        "workspacesilent 7,class:^(info.febvre.Komikku)"
        "workspacesilent 7,class:^(Upscayl)"
        "workspacesilent 8,class:^(com.obsproject.Studio)"
        "workspacesilent 9,class:^(obsidian)"
        "workspacesilent 9,class:^(Waydroid)"
