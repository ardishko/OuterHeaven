# asjdnasjnd
{
  xdg.mimeApps = {
    defaultApplications = {
      ...
      "x-scheme-handler/nxm" = [ "NexusMods.App" ];
      "application/x-doom" = [ "gzdoom.app" ];
      "application/x-64-rom" = [ "com.github.Rosalie241.RMG.desktop" ];
      "application/ztsd" = [ "org.kde.ark.desktop" ];
      ...
      "application/x-source-rom" = [ "org.kde.ark.desktop" ];
